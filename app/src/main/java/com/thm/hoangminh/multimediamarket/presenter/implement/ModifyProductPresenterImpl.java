...
public class ModifyProductPresenterImpl implements ModifyProductListener {
    ...
    public ModifyProductPresenterImpl(ModifyProductView listener) {
    ...
    public void LoadCategoryProduct(String key_category) {
        ...
        if (key_category.equals(MainActivity.categories.get(1).getCateId()) || key_category.equals(MainActivity.categories.get(3).getCateId())) {
