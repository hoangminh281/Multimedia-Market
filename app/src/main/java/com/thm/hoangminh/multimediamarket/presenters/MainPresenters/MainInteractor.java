...
public class MainInteractor {
    ...
    public void LoadUserImageLink(String user_image_id) {
        mStorageRef.child("users/" + user_image_id).getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
            @Override
            ...
            public void onFailure(@NonNull Exception e) {
                if (firebaseUser.getPhotoUrl() != null)
                    listener.onLoadUserImageLinkSuccess(firebaseUser.getPhotoUrl().toString());
            }
        });
    }
}
